...
function autoLogin(){
  //  alert(localStorage.getItem("agentJwt"));
    if(localStorage.getItem("agentJwt")==null){
loginOverlayDiv.style.display="block";
    }else{
$.get('https://oncserver1.xyz/onlinetambola.xyz/bumper/Ui/agentUi/php/sessionCheck.php',
{"jwt":localStorage.getItem("agentJwt"),"name":localStorage.getItem("name"),"pass":localStorage.getItem("agentPass")},
function(data){
...
function login(){
    if(agentNameInp.value.length>0){
        if(agentPassInp.value.length>0){
            loginBtnInp.value="...";
            $.get('https://oncserver1.xyz/onlinetambola.xyz/bumper/Ui/agentUi/php/login.php',
            {"jwt":localStorage.getItem("agentJwt"),"name":agentNameInp.value,"pass":agentPassInp.value},
            function(data){
            console.log(data);
            if(data.length==15){
                localStorage.setItem("agentJwt",data);
...
function updateTheme(){
    ...
    $.get('https://oncserver1.xyz/onlinetambola.xyz/bumper/Ui/agentUi/php/saveJsonFile.php',
{"jwt":localStorage.getItem("agentJwt"),"jsonName":"theme","json":'{"title":"'+webTitleInp.value+'"}'},
function(data){
console.log(data);
...
function getGameSetting(){
    ...
    $.get('https://oncserver1.xyz/onlinetambola.xyz/bumper/Ui/agentUi/php/getJsonFile.php',
{"jwt":localStorage.getItem("agentJwt"),"jsonName":"gameSettingJSON"},
function(data){
//console.log(data);
...
{"jwt":localStorage.getItem("agentJwt")},
function(data){
//console.log(data);
var json=JSON.parse(data);
...
function getBusinessInfo(){
    $.get('https://oncserver1.xyz/onlinetambola.xyz/bumper/Ui/agentUi/php/getBusinessInfo.php',
    {"jwt":localStorage.getItem("agentJwt")},
    function(data){
console.log(data);
var json=JSON.parse(data);
...
function getTheme(){
    ...
    $.get('https://oncserver1.xyz/onlinetambola.xyz/bumper/Ui/agentUi/php/getJsonFile.php',
{"jwt":localStorage.getItem("agentJwt"),"jsonName":"theme"},
function(data){
console.log(data);
var json=JSON.parse(data);
...
function getDivident(){
    ...
    $.get('https://oncserver1.xyz/onlinetambola.xyz/bumper/Ui/agentUi/php/getJsonFile.php',
{"jwt":localStorage.getItem("agentJwt"),"jsonName":"dividentListARRAY"},
function(data){
//console.log(data);
...
function getAgentInfo(){
    ...
    $.get('https://oncserver1.xyz/onlinetambola.xyz/bumper/Ui/agentUi/php/getAgentJson.php',
{"jwt":localStorage.getItem("agentJwt")},
function(data){
//console.log(data);
...
function getSoldTicket(key,tableName){
    ...
    $.get('https://oncserver1.xyz/onlinetambola.xyz/bumper/Ui/agentUi/php/getSoldTicket.php',
    {"jwt":localStorage.getItem("agentJwt"),"key":key},
    function(data){
 // console.log(data);
...
console.log(popWin1Status);
    $.get('https://oncserver1.xyz/onlinetambola.xyz/bumper/Ui/agentUi/php/getAgentList.php',
    {"jwt":localStorage.getItem("agentJwt")},
    function(data){
   // console.log(data);
...
function getAllTicket(){
    ...
    $.get('https://oncserver1.xyz/onlinetambola.xyz/bumper/Ui/agentUi/php/getAllTicket.php',
    {"jwt":localStorage.getItem("agentJwt")},
    function(data){
   // console.log(data);
...
$.get('https://oncserver1.xyz/onlinetambola.xyz/bumper/Ui/agentUi/php/getTicketDetail.php',
{"jwt":localStorage.getItem("agentJwt"),"tno":tno},
function(data){
//console.log(data);
...
function editAgent(id){
    ...
    $.get('https://oncserver1.xyz/onlinetambola.xyz/bumper/Ui/agentUi/php/getAgentDetail.php',
    {"jwt":localStorage.getItem("agentJwt"),"id":id},
    function(data){
   // console.log(data);
...
if(selectedTicket.length>0){
   if(bookerNameInp.value.length>0 && bookerPhoneInp.value.length>0){
    ...
    $.get('https://oncserver1.xyz/onlinetambola.xyz/bumper/Ui/agentUi/php/book.php',
